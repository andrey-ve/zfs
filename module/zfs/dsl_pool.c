 ...
 */
unsigned long zfs_dirty_data_max;
unsigned long zfs_dirty_data_max_max = 4ULL * 1024 * 1024 * 1024;
...
module_param(zfs_dirty_data_max_percent, int, 0644);
...
module_param(zfs_dirty_data_max_max, ulong, 0644);
MODULE_PARM_DESC(zfs_dirty_data_max_max, "caps zfs_dirty_data_max");
